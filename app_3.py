...
#SQLALCHEMY_DATABASE_URL = "mysql+pymysql://root:bYRfsLkuqhRiJsYGMjNRZGSLFkBskXiz@monorail.proxy.rlwy.net:20159/railway" # Railway Servicio BD Docente
SQLALCHEMY_DATABASE_URL = "mysql+pymysql://root:tBxaCxBmaSajbDajSxBUXCnAdZpQxzmZ@monorail.proxy.rlwy.net:21199/railway"  # Railway Servicio BD Alumno MCN
...
async def predict_bancknote(file: UploadFile = File(...), db: Session = Depends(get_db)):
    ...
    # return {"message": "Los datos han sido guardados satisfactoriamente"}